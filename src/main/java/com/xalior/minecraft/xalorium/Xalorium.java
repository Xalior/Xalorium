...
/*
   ...
   2) CommonProxy, ClientOnlyProxy, and DedicatedServerProxy are used to make sure your mod works correctly when installed on
      ...
      Where required code should have has separated Startup classes, (e.g. StartupCommon and StartupClientOnly) with
      methods which are called during the mod startup,
...
public class Xalorium
{
    ...
    public void init(FMLInitializationEvent event)
    {
        proxy.init();
        // some example code
        System.out.println("Xalorium loaded! W00T!");
    }
     ...
     * @param name
     * @return eg "xalorium:myblockname"
     */
