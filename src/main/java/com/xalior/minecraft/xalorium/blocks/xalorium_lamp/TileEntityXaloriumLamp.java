...
/**
 * Created by darran on 23/12/2016.
 */
public class TileEntityXaloriumLamp extends TileEntity implements ITickable {
    ...
    private void updateCounter() {
        ...
        delayCounter--;
        if (delayCounter <= 0) {
            List<EntityLivingBase> list = worldObj.getEntitiesWithinAABB(EntityLivingBase.class, new AxisAlignedBB(
